 ...
 */
public class OpenForVotesUser extends AppCompatActivity implements MyAdapter.ClickListener{
            ...
            public void onLoadMore() {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            if(searchUser != null){
                                tmp = BattleController.getOpenForVotingBattles(searchUser.getId(), page, 25).getData();
                            }else {
                                tmp = BattleController.getOpenForVotingBattles(aktUser.getId(), page, 25).getData();
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
    ...
    public void getOpenforVotesList(){
        ...
        try {
            if(searchUser != null) {
                tmp = BattleController.getOpenForVotingBattles(searchUser.getId(),0, 25).getData();
